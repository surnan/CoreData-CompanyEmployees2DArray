...
//        request.predicate = NSPredicate(format: "name CONTAINS %@", "G")
    ...
    override func viewDidLoad() {
        ...
        //Notice there's no function call to load table
        //NSFetch is already on it  -- just need to save into core data
    }
    
    
    @objc private func handleRefresh(){
        Service.shared.downloadCompaniesFromServer()
        refreshControl?.endRefreshing()  //Without this the spinning pinwheel goes on forever
    }
}

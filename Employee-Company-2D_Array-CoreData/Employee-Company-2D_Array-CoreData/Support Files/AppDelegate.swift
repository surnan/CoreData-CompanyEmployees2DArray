...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UINavigationBar.appearance().tintColor = UIColor.white  //makes the left & right bar button item text white
        
        window = UIWindow()
        window?.makeKeyAndVisible()
        //        let companiesController = CompaniesController()
//        let companiesController = CompaniesAutoUpdateController()
        let companiesController = CompaniesAutoUpdateController2()
